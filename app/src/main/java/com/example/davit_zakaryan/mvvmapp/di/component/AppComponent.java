...
import com.example.davit_zakaryan.mvvmapp.di.module.DataSourceModule;
...
@Singleton
@Component(modules = {AppModule.class, NetworkModule.class, ViewModelModule.class, DataSourceModule.class})
